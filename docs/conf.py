...
project = "test gh-rtd mit-or-apache-2-0 macos 3.13"
...
release = metadata.version("test_gh_rtd_mit_or_apache_2_0_macos_313")
...
html_theme_options = {
    "icon_links": [
        {
            "name": "ReadTheDocs",
            "url": "https://readthedocs.org/projects/test-gh-rtd-mit-or-apache-2-0-macos-313",
        ...
        },
        {
            ...
            "url": (
                "https://github.com/"
                "whiteprints-tests/"
                "test-gh-rtd-mit-or-apache-2-0-macos-313"
            ),
